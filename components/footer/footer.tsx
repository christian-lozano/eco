  ...
  return (
    <footer className="mt-auto">
      <div className=" bg-neutral-lightest justify-between px-20 py-24 laptop:flex">
        <footer className="bg-[var(--dark-mode)] font-sans dark:bg-white mt-20">
          <div className="container px-6 pt-12 mx-auto">
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-1 sm:gap-y-10 lg:grid-cols-3">
              <div className="sm:col-span-2 flex flex-col justify-center items-center">
                <h1 className="max-w-lg text-xl font-semibold tracking-tight  text-white xl:text-2xl dark:text-black">
              ...
              <div>
                ...
                <div className="flex justify-around md:justify-between items-center mt-5 ">
                  <Link
                    href="#"
                    className="uppercase text-xs md:ml-3 text-white transition-colors duration-300 dark:text-black dark:hover:text-blue-400 hover:underline hover:cursor-pointer hover:text-blue-500"
                  >
                    Hombre
                  </Link>
                  <Link
            ...
            <div className="sm:flex sm:items-center sm:justify-between   xl:flex xl:justify-around 2xl:flex 2xl:justify-around ">
              <div className=" flex justify-center mb-5">
                <svg
                  ...
                  className="dark:fill-black fill-white w-20 h-20"
                >
